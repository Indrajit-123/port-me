				...
				<div class="rs-inner">
								...
								<div class="panel-body">
									<form >
											...
											<div class="row">
												...
												<div class="col-sm-4">
													<div class="form-group">
														<input type="number" class="form-control" id="rs-form-example-email" placeholder="Select Quantity" disabled>
														<p class="help-block with-errors"></p>
													</div>
												</div>
											</div>
												...
												<div class="row atrri_add_cont">
														...
														<div class="col-sm-4">
															<div class="form-group">
																...
																<input type="text" name="attri[]" class="form-control" placeholder="Eg: color" disabled>
																<p class="help-block with-errors"></p>
															</div>
														</div>
														...
														<div class="col-sm-5">
															<div class="form-group">
																<div class="col-sm-10">
																	...
																	<input type="text" name="optn[]" class="form-control" placeholder="Red" disabled>
																	<p class="help-block with-errors"></p>
																</div>
					...
					<div class="panel-footer" style="background:#fff;">
							<div class="form-group m-a-0">
								...
								<a href="product_group.php"><button class="btn btn-success btn-wide">Back</button></a>
							</div>
						</div><!-- /.panel-footer -->
					</form>
				</div><!-- /.rs-inner -->
